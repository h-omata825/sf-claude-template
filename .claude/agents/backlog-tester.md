...
> 本 agent の Phase: 5（_index-phase5.md と _index-phase5-5.md と _index-cross.md を Read して判定）
...
`docs/logs/{issueID}/investigation.md` のテストシナリオと「種別」欄を読む。種別値（`バグ` / `追加要望` / `その他`）を確認し、後続の Step 4.5 の分岐判定に使用する。
