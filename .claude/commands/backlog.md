...
| フェーズ | エージェント | 主な成果物 |
|---|---|---|
| Phase 0: 作業フォルダ作成 | orchestrator | `docs/logs/{issueID}/` |
...
`docs/logs/{issueID}/investigation.md` が既に存在する場合は再実行。AskUserQuestion で **[Phase 1 から再調査 / 途中フェーズから再開 / 中止]** を提示してユーザに確認する。
...
> **次に進む条件**: ユーザが調査レポートを確認した後 — AskUserQuestion で **[承認 / 修正依頼 / 中止]** を提示する
...
> **次に進む条件**: ユーザが対応方針を承認した後 — AskUserQuestion で **[承認 / 修正依頼 / 中止]** を提示する
...
> **次に進む条件**: 全判断ポイントをユーザが確認・確定した後 — AskUserQuestion で **[承認 / 修正依頼 / 中止]** を提示する
...
> **次に進む条件**: ユーザが実装内容を確認した後 — AskUserQuestion で **[承認 / 修正依頼 / 中止]** を提示する
...
> **次に進む条件**: 全テスト PASS をユーザが確認した後 — AskUserQuestion で **[承認 / 修正依頼 / 中止]** を提示する
